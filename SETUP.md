...
_Catatan: Jika Anda sudah menjalankan skema SQL mentah dari repo FastAPI, Anda mungkin perlu melakukan `migrate:refresh` jika ada konflik._
...
## 📘 Dokumentasi API Backend (Swagger/OpenAPI)

Setelah backend berjalan, tim dapat membuka dokumentasi interaktif:

- UI Dokumentasi: `http://127.0.0.1:8000/docs/api`
- Dokumen OpenAPI JSON: `http://127.0.0.1:8000/docs/api.json`

Jika ingin mengekspor spesifikasi OpenAPI ke file JSON untuk CI/CD atau sharing:
